-- =============================================================================
-- BELLO SUITE — Module Commercial Migration
-- Exécute ce fichier sur : https://supabase.com/dashboard/project/guhwnihenpqoxcugtkyr/sql/new
-- =============================================================================
...
ALTER TABLE "ASPConfiguration" ENABLE ROW LEVEL SECURITY;
